 ...
 * 
 * 
 * Generally relying on implicitlyWait slows things down so use WaitTool
...
public class WaitTool {
	...
	/* Wait for an element to appear on the web-page. And returns the
	 * boolean using the given method.
	 * 
	 * This method is to deal with dynamic pages.
	 * 
	 * @param WebDriver
	...
	public static boolean waitForElementDisplay(WebDriver driver,
		...
		try {
			...
			isPresent = isElementPresentAndDisplay(driver, by);
			driver.manage().timeouts()
					.implicitlyWait(DEFAULT_WAIT_4_PAGE, TimeUnit.SECONDS); // reset
																			// implicitlyWait
			return isPresent;
	...
	/**
	 * This method is for fluentwait to identify element on the page.
	 * @param driver
	 * @param by
	 * @return
	 */
